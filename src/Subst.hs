...
global2Free (Fix info name1 t1 name2 ty2 tm) = let tm' = global2Free tm in (Fix info name1 t1 name2 ty2 tm')
global2Free (IfZ info tm tt tf) =
  let tmm = global2Free tm
      tmt = global2Free tt
      tmf = global2Free tmf
   in (IfZ info tmm tmt tmf)
